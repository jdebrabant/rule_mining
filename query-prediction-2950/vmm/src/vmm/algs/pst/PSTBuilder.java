...
public class PSTBuilder {
  ...
  public PSTNodeInterface build(SamplesInt samples, double pMin, double alpha,
   ...
   * @return
   */
  public PSTNodeInterface buildGolanPST(SamplesInt samples, int nMin, int minNumHits,
