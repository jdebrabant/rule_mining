...
{                               /* --- Fisher's exact test (prob.) */
  ...
  cut *= 1-DBL_EPSILON;         /* adapt for roundoff errors */
...
{                               /* --- Fisher's exact test (info.) */
  ...
  com = logGamma(     head+1) +logGamma(     body+1)
      + logGamma(base-head+1) +logGamma(base-body+1)
      - logGamma(base+1);       /* compute common probability term */
  cut = re_info(supp, body, head, base) *(1-DBL_EPSILON);
  for (sum = supp = 0; supp <= body; supp++) {
...
static const REINFO reinfo[] ={ /* --- rule evaluation functions */
  /* RE_NONE       0 */  { re_none,       0 },
  /* RE_CONF       1 */  { re_conf,      +1 },
  /* RE_CONFDIFF   2 */  { re_confdiff,  +1 },
  /* RE_LIFT       3 */  { re_lift,      +1 },
  /* RE_LIFTDIFF   4 */  { re_liftdiff,  +1 },
  /* RE_LIFTQUOT   5 */  { re_liftquot,  +1 },
  /* RE_CVCT       6 */  { re_cvct,      +1 },
  /* RE_CVCTDIFF   7 */  { re_cvctdiff,  +1 },
  /* RE_CVCTQUOT   8 */  { re_cvctquot,  +1 },
  /* RE_CERT       9 */  { re_cert,      +1 },
  /* RE_CHI2      10 */  { re_chi2,      +1 },
  /* RE_CHI2PVAL  11 */  { re_chi2pval,  -1 },
  /* RE_YATES     12 */  { re_yates,     +1 },
  /* RE_YATESPVAL 13 */  { re_yatespval, -1 },
  /* RE_INFO      14 */  { re_info,      +1 },
  /* RE_INFOPVAL  15 */  { re_infopval,  -1 },
  /* RE_FETPROB   16 */  { re_fetprob,   -1 },
  /* RE_FETCHI2   17 */  { re_fetchi2,   -1 },
  /* RE_FETINFO   18 */  { re_fetinfo,   -1 },
  /* RE_FETSUPP   19 */  { re_fetsupp,   -1 },
