...
public final class GalaxyXML {
     ...
     */
    public static void parseInput(String inFile, TimeInfo timeInfo, SolarBodyManager solarBodyManager) throws XMLInputException {
        try {
            ...
            if (!root.getName().equals("SOLAR")) {
                throw new XMLInputException("Invalid root tag: should be SOLAR");
            }
            parseRootAttributes(root, timeInfo);
            // Parses through each element of the root
            for (Iterator i = root.elementIterator(); i.hasNext();) {
                solarBodyManager.addBody(xmlToSolarBody((Element) i.next()));
            }
     ...
     * @throws SolarXMLInputException
     */
    private static void parseRootAttributes(Element root, TimeInfo timeInfo) throws XMLInputException {
        ...
        for (Iterator i = root.attributeIterator(); i.hasNext();) {
            ...
            if (attrName.equals("TIME")) {
                ...
                throw new XMLInputException("Invalid attribute in SOLAR tag");
            }
        ...
        if (init >= 0 && step >= 0 && numSteps >= 0) {
            ...
            throw new XMLInputException("Invalid/missing time value in SOLAR tag");
        }
    }
     ...
     */
    public static void writeOutput(String outFile, TimeInfo timeInfo, SolarBodyManager solarBodyManager, double currTime) {
        try {
    ...
    private static Element solarBodyToXML(SolarBody body) {
        ...
        if (type.equals("ROCKET")) {
            ...
            Vector3D thrust = body.getDefaultForce();
    ...
    /**
     * Converts a SolarBody's xml to a SolarBody
     * @param root - The XML element for this SolarBody
     * @return - A new SolarBody
     * @throws XMLInputException   
     */
    private static SolarBody xmlAttributesToSolarBody(Element root) throws XMLInputException {
        ...
        for (Iterator i = root.attributeIterator(); i.hasNext();) {
            ...
            if (attrName.equals("NAME")) {
                ...
                throw new XMLInputException("Invalid OBJECT attribute");
            }
        }
        if (name == null || type == null || mass <= 0 || radius < 0) {
            throw new XMLInputException("Missing/Invalid OBJECT attribute");
        }
     ...
     * @throws SolarXMLInputException
     */
    private static SolarBody xmlToSolarBody(Element root) throws XMLInputException {
        SolarBody newBody = xmlAttributesToSolarBody(root);
        ...
        for (Iterator i = root.elementIterator(); i.hasNext();) {
            ...
            for (Iterator i2 = element.attributeIterator(); i2.hasNext();) {
                ...
                if (attrName.equals("X")) {
                    ...
                    throw new XMLInputException("Invalid attribute: should be X, Y, or Z");
                }
            }
            ...
            if (x != Double.NaN && y != Double.NaN && z != Double.NaN) {
                ...
                if (elementName.equals("POSITION")) {
                    ...
                    throw new XMLInputException("Invalid element in an OBJECT");
                }
            } else {
                throw new XMLInputException("XML file missing a X, Y, or Z value");
            }
        }
        return newBody;
    }
